...
import com.musicbrainz.mp3.tagger.Tools.Song.MusicBrainzQuery.Builder;
...
public class Song {
	...
	public String getMBID() {
		String mbid = getFirstRecording().get("id").asText();
	...
	private JsonNode getFirstRecording() {
		JsonNode recordings = json.get("recordings").get(0);
		return recordings;
	}
	...
	public static class Tagger {
		...
		public static JsonNode fetchMBRecordingJSONFromFile(File f) {
			...
			System.out.println(Tools.nodeToJsonPretty(jsonNode));
			return jsonNode;
